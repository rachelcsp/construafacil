...
class _EstaduaisViewState extends State<EstaduaisView> {
    ...
    return Scaffold(
      ...
      body: Center(
        child: StreamBuilder<QuerySnapshot>(
          //fluxo de dados
          stream: EstaduaisController().listarEstaduais().snapshots(),
          //exibição dos dados
  ...
  // ADICIONAR TAREFA
  //
  void salvarEstaduais(context, {docId}) {
    showDialog(
      context: context,
      builder: (BuildContext context) {
        // retorna um objeto do tipo Dialog
        return AlertDialog(
          title: Text((docId == null) ? "Adicionar Estaduais" : "Editar "),
          content: SizedBox(
            height: 450,
            width: 300,
            child: Column(
